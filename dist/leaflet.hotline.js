...
const HotlineUtil = {
    ...
    clipSegment: function (a, b, bounds, useLastCode, round) {
        let codeA = useLastCode ? this._lastCode : LineUtil._getBitCode(a, bounds), codeB = LineUtil._getBitCode(b, bounds), codeOut, p, newCode;
